 ...
 *                   loading the file.
 */
 DBFParser.load = function(fileName, arrayBuffer, callback, onerror) {
  
    // var d = new DBFParser().parse(arrayBuffer,fileName);
	var d = new DBFParser.prototype.parse(arrayBuffer, fileName);
    callback(d);
};
